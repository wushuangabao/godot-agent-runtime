...
该默认许可覆盖项目的 TypeScript/JavaScript 核心代码、MCP Server、CLI 以及未另行标注许可的其他文件。`addons/godot_agent_runtime/` 整个子目录由该目录内的 [MIT LICENSE](addons/godot_agent_runtime/LICENSE) 和文件级 SPDX 标识覆盖，其中包括 Godot EditorPlugin 与 Runtime Bridge。
